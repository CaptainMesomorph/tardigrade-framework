...
- Created a user context in AspNetCore based upon the IHttpContextAccessor.
- Replaced the deprecated WindowsAzure.Storage package from the AuditNET and AzureStorage projects.
- Updated the Create operations of the Repository class in the EntityFrameworCore project to reject object IDs which are set to their "default" values.
